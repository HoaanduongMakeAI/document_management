frappe.ui.form.on('Outgoing Document', {
    ...
    refresh: function(frm) {
        ...
        frm.toggle_display(['submit_for_department_approval_btn', 'department_approve_btn', 'department_request_edit_btn', 'leadership_approve_btn', 'leadership_request_edit_btn', 'sign_document_btn'], false);
        ...
        if (frm.doc.approval_status === 'Draft' && frm.doc.created_by_user === frappe.session.user) {
            ...
            frm.toggle_display(['department_approve_btn', 'department_request_edit_btn'], true);
        } else if (frm.doc.approval_status === 'Pending Leadership Review' && frm.doc.leadership_reviewer === frappe.session.user) {
            frm.toggle_display(['leadership_approve_btn', 'leadership_request_edit_btn'], true);
