...
def get_access_token():
    ...
    if not access_token:
        ...
        frappe.throw(f"Could not retrieve active token for Connected App '{settings.connected_app}' for user '{frappe.session.user}'. Redirecting to login to obtain a new token. Please <a href='{auth_url}' target='_blank'>click here</a> to log in.<script>window.location.href = '{auth_url}';</script>", title="Authentication Required")
